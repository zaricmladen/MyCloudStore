...
namespace Algorithms
{
    public class TigerHash
    {
        ...
        //Svodjenje na duzinu koja je umnozak od 512
        ...
        public byte[] Crypt(byte[] input)
        {
            ...
            byte[] segment = new byte[64]; // poruku treba procesirati kao niz 64B segmenata
            ulong[] w = new ulong[8]; // segment podeliti na 8 delova od po 8B

            for (int i = 0; i < prosirenInput.Length / 64; i++) // svaki segment
            {
